...
// assets
const imgcust1 = '/assets/images/landing/client-01.png';
const imgcust2 = '/assets/images/landing/client-02.png';
const imgcust3 = '/assets/images/landing/client-03.png';
const imgcust4 = '/assets/images/landing/client-04.png';
          ...
          <Grid item xs={12}>
            <Grid container spacing={5} justifyContent="center" sx={{ mb: 4, textAlign: 'center' }}>
              {partnerimage.map((item, index) => (
                <Grid item key={index}>
                  <Image src={item.image} alt="feature" width={200} height={57} />
                </Grid>
              ))}
            </Grid>
          </Grid>
