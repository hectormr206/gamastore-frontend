...
import { Box, Dialog, Grid, Menu, MenuItem, Stack, TextField, Typography, useMediaQuery } from '@mui/material';
              ...
              >
                <Grid container spacing={3}>
                  ...
                  <Grid item xs={12}>
                    ...
                    >
                      <Box sx={{ pl: 1, pr: 3 }}>{data && <ChatHistory theme={theme} user={user} data={data} />}</Box>
                    </SimpleBar>
                  </Grid>
                  <Grid
                    item
                  ...
                  >
                    <Stack>
                      ...
                      <Stack direction="row" justifyContent="space-between" alignItems="center">
                        <Stack direction="row" sx={{ py: 2, ml: -1 }} alignItems="center">
