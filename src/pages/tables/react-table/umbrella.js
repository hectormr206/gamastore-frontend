  ...
  const columns = useMemo(
    () => [
      ...
      },
      {
        ...
        disableGroupBy: true,
        // eslint-disable-next-line
        Cell: ({ value }) => <Avatar alt="Avatar 1" size="sm" src={`/assets/images/users/avatar-${!value ? 1 : value}.png`} />
      },
      {
        Header: 'First Name',
        Footer: 'First Name',
...
UmbrellaTable.getLayout = function getLayout(page) {
